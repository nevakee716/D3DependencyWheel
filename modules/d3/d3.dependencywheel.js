...
d3.chart.dependencyWheel = function(options) {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var itemsByKey = data.itemsByKey;
      var dataByName = data.dataByName;
      ...
      g.append("svg:text")
        ...
        .style("cursor", "pointer").style("fill", function(d){
          if (itemsByKey.hasOwnProperty(packageNames[d.index])){
            return "red";
          }
          return "black";
        })
        ...
        .on("mouseout", fade(1))
        .on("click", function(d){
          if (dataByName.hasOwnProperty(packageNames[d.index])){
            location.href = dataByName[packageNames[d.index]]; 
          }
        });
